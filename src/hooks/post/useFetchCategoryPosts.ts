...
const API_ENDPOINT = 'https://trickbd.com/apixyzv1/get_category_posts/';

export default function useFetchCategoryPosts(slug) {
    ...
    async (newPage = 1) => {
      ...
      try {
        const response = await axios.get(API_ENDPOINT, {
          params: {
            include:
              'id,title,thumbnail,custom_fields,date,excerpt,author,date,categories,comments',
            page: newPage,
            slug,
          },
          timeout: 50000,
