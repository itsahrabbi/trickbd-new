...
import { truncateStr, shortenStr, getWPmedia, formatDate } from "@/src/helpers";
            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <View style={styles.headerText}>
                        <Text style={styles.name}>{decode(authorName)}</Text>
                        <Text style={styles.name}>in</Text>
                        <Text style={[styles.name, { fontWeight: "bold" }]}>
                            {truncateStr(decode(categories), 70)}
                        </Text>
                    </View>
                </View>
                <TouchableOpacity onPress={onPress} style={styles.boxContainer}>
                    <View>
                        <Text style={styles.title}>
                            {truncateStr(decode(title), 45)}
                        </Text>
                        <Text style={styles.subtitle}>
                            {truncateStr(shortenStr(decode(excerpt), 60), 48)}
                        </Text>
                    </View>
